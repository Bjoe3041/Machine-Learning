...
class Vectorizer:
    ...
    def TFIDF_NewVectorize(self, data_preprocessed: pd.DataFrame, tfidf_vectorizer: TfidfVectorizer):
        #data_preprocessed = data_preprocessed[''].astype(int)  # Convert values
        data_sorted = data_preprocessed.sort_values(by=['doi', 'Title_value'], ascending=[True, False])
